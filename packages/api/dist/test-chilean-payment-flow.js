...
exports.mockChileanCalculation = exports.mockChileanUser = exports.mockChileanTransferData = void 0;
exports.runChileanPaymentFlowTests = runChileanPaymentFlowTests;
const TransferStatus_1 = require("../components/features/TransferStatus");
// Mock Chilean transfer data
const mockChileanTransferData = {
    transferId: 'chilean-transfer-123',
    status: TransferStatus_1.TransferStatusEnum.CHILEAN_BANK_PROCESSING,
...
exports.mockChileanTransferData = mockChileanTransferData;
...
exports.mockChileanUser = mockChileanUser;
...
exports.mockChileanCalculation = mockChileanCalculation;
/**
...
function testChileanPaymentForm() {
    ...
    const hasChileanAccount = mockChileanUser.verifiedPaymentMethods.some(method => method.currency === 'CLP' && method.country === 'CL');
    ...
    console.log('✅ Chilean transfer request structure:', {
        hasRequiredFields: !!(chileanTransferRequest.sendAmount &&
...
function testChileanTransferStatus() {
    ...
    const statusMappings = {
        [TransferStatus_1.TransferStatusEnum.CHILEAN_BANK_PROCESSING]: 'Processing Chilean Bank Transfer',
        [TransferStatus_1.TransferStatusEnum.CHILEAN_VERIFICATION_PENDING]: 'Awaiting Bank Verification',
        [TransferStatus_1.TransferStatusEnum.CHILEAN_MICRODEPOSIT_SENT]: 'Microdeposits Sent'
    };
    console.log('✅ Chilean status mappings:', Object.keys(statusMappings).length > 0);
    // Test 2: Progress calculation
    const progressMappings = {
        [TransferStatus_1.TransferStatusEnum.CHILEAN_BANK_PROCESSING]: 50,
        [TransferStatus_1.TransferStatusEnum.CHILEAN_VERIFICATION_PENDING]: 30,
        [TransferStatus_1.TransferStatusEnum.CHILEAN_MICRODEPOSIT_SENT]: 70
    };
...
function testChileanUtilities() {
    ...
    const chileanUsers = users.filter(user => user.country === 'CL' &&
