...
exports.CurrencyConfigService = void 0;
class CurrencyConfigService {
     ...
     */
    static getSendCurrencies() {
        return [...this.SEND_CURRENCIES];
    }
    /**
     * Get supported receive currencies
     */
    static getReceiveCurrencies() {
        return [...this.RECEIVE_CURRENCIES];
    }
    /**
     * Check if currency is supported for sending
     */
    static isSendCurrencySupported(code) {
        return this.SEND_CURRENCIES.includes(code.toUpperCase());
    }
    /**
     * Check if currency is supported for receiving
     */
    static isReceiveCurrencySupported(code) {
        return this.RECEIVE_CURRENCIES.includes(code.toUpperCase());
    }
    /**
     ...
     */
    static validateAmount(amount, currencyCode) {
     ...
     */
    static formatNumberInput(value, currencyCode) {
        const currency = this.getCurrency(currencyCode);
        if (!currency) {
            return value;
        }
     ...
     */
    static getCurrencyDisplayName(currencyCode) {
        const currency = this.getCurrency(currencyCode);
        if (!currency) {
            return currencyCode;
        }
     ...
     */
    static getEstimatedArrival(toCurrency) {
     ...
     */
    static getSupportedCurrencyPairs() {
        const pairs = [];
...
exports.CurrencyConfigService = CurrencyConfigService;
CurrencyConfigService.SUPPORTED_CURRENCIES = {
    USD: {
        code: 'USD',
        name: 'US Dollar',
        symbol: '$',
