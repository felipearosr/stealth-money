...
describe('MantleService - Transfer Operations', () => {
    ...
    beforeEach(async () => {
        ...
        mantleService.provider = mockProvider;
    });
    describe('initiateTransfer', () => {
        const baseTransferRequest = {
    ...
    describe('getTransferStatus', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(mantleService, 'getTransactionHashForTransfer')
    ...
    describe('monitorTransfer', () => {
        ...
        it('should monitor transfer until confirmation', async () => {
            const finalStatus = await mantleService.monitorTransfer(mockTransferId, statusUpdateCallback, 10000 // 10 second timeout for test
            );
        ...
        it('should timeout for long-running transfers', async () => {
            ...
            const finalStatus = await mantleService.monitorTransfer(mockTransferId, undefined, 1000 // 1 second timeout
            );
