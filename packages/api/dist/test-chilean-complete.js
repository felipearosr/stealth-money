...
async function testCompleteChileanFlow() {
    ...
    const clpConfig = currency_config_service_1.CurrencyConfigService.getCurrency('CLP');
    ...
    // Test minimum amount
    const minValidation = currency_config_service_1.CurrencyConfigService.validateCurrencyPair('CLP', 'CLP', 500);
    console.log('Below minimum (500 CLP):', minValidation || 'Valid');
    const validValidation = currency_config_service_1.CurrencyConfigService.validateCurrencyPair('CLP', 'CLP', 10000);
    console.log('Valid amount (10,000 CLP):', validValidation || 'Valid');
    const maxValidation = currency_config_service_1.CurrencyConfigService.validateCurrencyPair('CLP', 'CLP', 50000000);
