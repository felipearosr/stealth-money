...
exports.cookathonController = exports.CookathonController = void 0;
const database_service_1 = require("../services/database.service");
class CookathonController {
    constructor() {
     ...
     */
    async getCookathonMetrics(req, res) {
        try {
    ...
    async getTransferStatistics(startDate, endDate) {
        try {
    ...
    getMockRecentTransactions(limit = 10) {
        const transactions = [];
...
exports.CookathonController = CookathonController;
exports.cookathonController = new CookathonController();
