...
class SimpleDatabaseService {
     ...
     */
    async getTransactionByCirclePaymentId(circlePaymentId) {
        if (!this.isConfigured || !this.pool) {
            return null;
        }
        const query = `
     ...
     */
    async getTransactionByCircleTransferId(circleTransferId) {
        if (!this.isConfigured || !this.pool) {
            return null;
        }
        const query = `
     ...
     */
    async getTransactionByCirclePayoutId(circlePayoutId) {
        if (!this.isConfigured || !this.pool) {
            return null;
        }
        const query = `
