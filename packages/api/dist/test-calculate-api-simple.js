...
const transferMethodSchema = zod_1.z.object({
    method: zod_1.z.enum(['circle', 'mantle']),
    sendAmount: zod_1.z.number(),
    receiveAmount: zod_1.z.number(),
    exchangeRate: zod_1.z.number(),
    fees: zod_1.z.object({
        processing: zod_1.z.number(),
        network: zod_1.z.number(),
        exchange: zod_1.z.number(),
    ...
    availableForAmount: zod_1.z.boolean()
});
const enhancedCalculateResponseSchema = zod_1.z.object({
    sendAmount: zod_1.z.number(),
    sendCurrency: zod_1.z.string(),
    receiveCurrency: zod_1.z.string(),
    calculatorMode: zod_1.z.string().optional(),
    transferMethods: zod_1.z.array(transferMethodSchema),
    recommendedMethod: zod_1.z.string(),
    recommendation: zod_1.z.object({
        method: zod_1.z.string(),
        reason: zod_1.z.string(),
        costSavings: zod_1.z.number(),
        timeSavings: zod_1.z.string().optional()
    }),
    comparison: zod_1.z.object({
        costDifference: zod_1.z.number(),
        timeDifference: zod_1.z.string(),
        mantleSavings: zod_1.z.object({
            percentage: zod_1.z.string(),
            absolute: zod_1.z.string()
        })
    }).optional(),
...
exports.default = testCalculateAPIStructure;
