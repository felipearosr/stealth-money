...
/**
 * Transfer context for notifications
 */
...
export class NotificationService {
   ...
   */
  private async sendWebhookNotification(request: NotificationRequest): Promise<NotificationResult> {
   ...
   */
  private getNotificationTemplate(type: NotificationType, context: TransferContext): NotificationTemplate {
   ...
   */
  private generateHtmlTemplate(templateType: string, context: TransferContext): string {
    const baseTemplate = `
      <!DOCTYPE html>
      <html>
      <head>
   ...
   */
  registerClient(clientId: string, websocket: any): void {
  ...
  async notifyTransferEvent(
    ...
    channels: NotificationChannel[] = [NotificationChannel.EMAIL, NotificationChannel.BROWSER]
  ): Promise<NotificationResult[]> {
   ...
   */
  private async mockSendSms(smsData: any): Promise<void> {
   ...
   */
  private async mockBroadcastWebSocket(message: any): Promise<void> {
   ...
   */
  private async mockSendToClient(clientId: string, message: any): Promise<void> {
