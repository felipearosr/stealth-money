...
import { MantleService, MantleTransferRequest } from './services/mantle.service';
...
async function testMantleTransferFunctionality() {
  ...
  try {
    ...
    const mockTransferRequest: MantleTransferRequest = {
...
export { testMantleTransferFunctionality };