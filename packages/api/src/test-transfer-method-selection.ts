...
import { TransferService, TransferMethod, CalculateTransferRequest } from './services/transfer.service';
  ...
  try {
   ...
   ${option.method.toUpperCase()} Option:
    ...
    const preferenceTests = [
      { amount: 500, preferred: TransferMethod.CIRCLE, description: 'User prefers Circle' },
      { amount: 500, preferred: TransferMethod.MANTLE, description: 'User prefers Mantle' }
    ];
...
export { testTransferMethodSelection };